...
<html lang="cat">
    ...
    <body>
        ...
        <div class="div_carret_button">
            <form method="post" action="carret.php" id="myform" name="myform">
                <input name="idProd" type="hidden" value="<?= $prod['id'] ?>">
                <button class="button2" name="delProd" type="submit">Carret</button><br><br>
            </form>
        </div>
                    ...
                    while($prod = $result->fetch_assoc()){
                        ...
                        ?>
                            <div class="flex-item-prod2">
                                ...
                                <p> <?=$prod["descripcio"] ?></p>
                                <p> <?=$prod["preu"] ?>€</p>
                                <form method="post" id="addProdCart" name="myform">
                                    <input name="idProd" type="hidden" value="<?= $prod['id'] ?>">
                                    <button class="button2" name="addProdCartButton" type="submit">Afegir al Carret</button><br><br>
                                </form>
                            </div>
                        <?php
                    }
